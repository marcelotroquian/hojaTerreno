    ...
    return Column(
      children: [
        ...
        _SeccionBtn(
          ...
          completada: radiografica.estaCompleto, color: Colors.green,
          onTap: () async {
        ...
        _SeccionBtn(
          ...
          completada: fabricacion.estaCompleto, color: Colors.teal,
          onTap: () async {
        ...
        _SeccionBtn(
          ...
          completada: hermeticidad.estaCompleto, color: Colors.cyan,
          onTap: () async {
        ...
        _SeccionBtn(
          ...
          completada: recubrimiento.estaCompleto, color: Colors.lightGreen,
          onTap: () async {
        ...
        _SeccionBtn(
          ...
          completada: accesorios.estaCompleto, color: Colors.blueGrey,
          onTap: () async {
        ...
        _SeccionBtn(
          ...
          completada: placa.estaCompleto, color: Colors.green,
          onTap: () async {
